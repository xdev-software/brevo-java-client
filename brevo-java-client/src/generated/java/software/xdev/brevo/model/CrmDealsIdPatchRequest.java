...
public class CrmDealsIdPatchRequest {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LINKED_CONTACT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLinkedContactIds() != null) {
      for (int i = 0; i < getLinkedContactIds().size(); i++) {
        try {
          joiner.add(String.format(java.util.Locale.ROOT, "%slinkedContactIds%s%s=%s", prefix, suffix,

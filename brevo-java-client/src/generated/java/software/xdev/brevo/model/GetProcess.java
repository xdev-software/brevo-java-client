...
public class GetProcess {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_EXPORT_URL, required = false)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExportUrl() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sexport_url%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getExportUrl()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }

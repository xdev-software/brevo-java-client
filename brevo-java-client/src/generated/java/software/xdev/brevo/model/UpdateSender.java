 ...
 */
@JsonPropertyOrder({
  UpdateSender.JSON_PROPERTY_NAME,
  UpdateSender.JSON_PROPERTY_EMAIL,
  UpdateSender.JSON_PROPERTY_IPS
})
@JsonTypeName("updateSender")
public class UpdateSender {
  ...
  public UpdateSender name(@jakarta.annotation.Nullable String name) {
  ...
  public UpdateSender email(@jakarta.annotation.Nullable String email) {
  ...
  public UpdateSender ips(@jakarta.annotation.Nullable List<CreateSenderIpsInner> ips) {
    
    this.ips = ips;
    return this;
  }

  public UpdateSender addIpsItem(CreateSenderIpsInner ipsItem) {
    if (this.ips == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateSender.name) &&
        Objects.equals(this.email, updateSender.email) &&
        Objects.equals(this.ips, updateSender.ips);
  }

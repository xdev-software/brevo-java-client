...
public class PutresendcancelinvitationResponse {
  ...
  public PutresendcancelinvitationResponse status(@jakarta.annotation.Nonnull String status) {
  ...
  public PutresendcancelinvitationResponse creditNotes(@jakarta.annotation.Nullable List<String> creditNotes) {

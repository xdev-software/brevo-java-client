 ...
 */
@JsonPropertyOrder({
  CreateSmtpTemplateSender.JSON_PROPERTY_NAME,
  CreateSmtpTemplateSender.JSON_PROPERTY_EMAIL,
  CreateSmtpTemplateSender.JSON_PROPERTY_ID
})
@JsonTypeName("createSmtpTemplate_sender")
public class CreateSmtpTemplateSender {
  ...
  public CreateSmtpTemplateSender() {
  }

  public CreateSmtpTemplateSender name(@jakarta.annotation.Nullable String name) {
  ...
  public CreateSmtpTemplateSender email(@jakarta.annotation.Nullable String email) {
  ...
  public CreateSmtpTemplateSender id(@jakarta.annotation.Nullable Long id) {

 ...
 */
@JsonPropertyOrder({
  RemoveContactFromListByExtIDs.JSON_PROPERTY_EXT_IDS
})
@JsonTypeName("removeContactFromListByExtIDs")
public class RemoveContactFromListByExtIDs {
  public static final String JSON_PROPERTY_EXT_IDS = "extIds";
  @jakarta.annotation.Nullable
  private List<String> extIds = new ArrayList<>();

  public RemoveContactFromListByExtIDs() {
  }

  public RemoveContactFromListByExtIDs extIds(@jakarta.annotation.Nullable List<String> extIds) {
    
    this.extIds = extIds;
    return this;
  }

  public RemoveContactFromListByExtIDs addExtIdsItem(String extIdsItem) {
    if (this.extIds == null) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveContactFromListByExtIDs removeContactFromListByExtIDs = (RemoveContactFromListByExtIDs) o;
    return Objects.equals(this.extIds, removeContactFromListByExtIDs.extIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveContactFromListByExtIDs {\n");

 ...
 */
@JsonPropertyOrder({
  RemainingCreditModelChild.JSON_PROPERTY_SMS,
  RemainingCreditModelChild.JSON_PROPERTY_EMAIL
})
@JsonTypeName("remainingCreditModel_child")
public class RemainingCreditModelChild {
  ...
  public RemainingCreditModelChild() {
  }

  public RemainingCreditModelChild sms(@jakarta.annotation.Nonnull Double sms) {
  ...
  public RemainingCreditModelChild email(@jakarta.annotation.Nonnull Double email) {

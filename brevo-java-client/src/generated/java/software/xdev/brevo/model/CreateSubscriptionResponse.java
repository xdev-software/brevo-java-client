 ...
 */
@JsonPropertyOrder({
  CreateSubscriptionResponse.JSON_PROPERTY_ORGANIZATION_ID,
  CreateSubscriptionResponse.JSON_PROPERTY_LOYALTY_PROGRAM_ID,
  CreateSubscriptionResponse.JSON_PROPERTY_VERSION_ID,
  CreateSubscriptionResponse.JSON_PROPERTY_CONTACT_ID,
  CreateSubscriptionResponse.JSON_PROPERTY_LOYALTY_SUBSCRIPTION_ID,
  CreateSubscriptionResponse.JSON_PROPERTY_CREATED_AT,
  CreateSubscriptionResponse.JSON_PROPERTY_UPDATED_AT
})
@JsonTypeName("createSubscriptionResponse")
public class CreateSubscriptionResponse {
  ...
  public CreateSubscriptionResponse organizationId(@jakarta.annotation.Nullable Integer organizationId) {
  ...
  public CreateSubscriptionResponse loyaltyProgramId(@jakarta.annotation.Nullable UUID loyaltyProgramId) {
  ...
  public CreateSubscriptionResponse versionId(@jakarta.annotation.Nullable Integer versionId) {
  ...
  public CreateSubscriptionResponse contactId(@jakarta.annotation.Nullable Integer contactId) {
  ...
  public CreateSubscriptionResponse loyaltySubscriptionId(@jakarta.annotation.Nullable String loyaltySubscriptionId) {
  ...
  public CreateSubscriptionResponse createdAt(@jakarta.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public CreateSubscriptionResponse updatedAt(@jakarta.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationId, createSubscriptionResponse.organizationId) &&
        Objects.equals(this.loyaltyProgramId, createSubscriptionResponse.loyaltyProgramId) &&
        Objects.equals(this.versionId, createSubscriptionResponse.versionId) &&
        Objects.equals(this.contactId, createSubscriptionResponse.contactId) &&
        Objects.equals(this.loyaltySubscriptionId, createSubscriptionResponse.loyaltySubscriptionId) &&
        Objects.equals(this.createdAt, createSubscriptionResponse.createdAt) &&
        Objects.equals(this.updatedAt, createSubscriptionResponse.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organizationId, loyaltyProgramId, versionId, contactId, loyaltySubscriptionId, createdAt, updatedAt);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVersionId() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sversionId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVersionId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }

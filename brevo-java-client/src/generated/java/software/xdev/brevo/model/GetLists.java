...
public class GetLists {
  ...
  private List<GetListsListsInner> lists = new ArrayList<>();
  ...
  public GetLists lists(@jakarta.annotation.Nullable List<GetListsListsInner> lists) {
  ...
  @JsonProperty(JSON_PROPERTY_LISTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLists(@jakarta.annotation.Nullable List<GetListsListsInner> lists) {
    this.lists = lists;
  }

  public GetLists count(@jakarta.annotation.Nullable Long count) {

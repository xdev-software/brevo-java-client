...
import software.xdev.brevo.model.UpsertrecordsRequestRecordsInnerOneOf;
import software.xdev.brevo.model.UpsertrecordsRequestRecordsInnerOneOf1;
...
/**
 * UpsertrecordsRequestRecordsInner
 */
@JsonPropertyOrder({
  UpsertrecordsRequestRecordsInner.JSON_PROPERTY_ATTRIBUTES,
  UpsertrecordsRequestRecordsInner.JSON_PROPERTY_IDENTIFIERS,
  UpsertrecordsRequestRecordsInner.JSON_PROPERTY_ASSOCIATIONS
})
@JsonTypeName("upsertrecords_request_records_inner")
public class UpsertrecordsRequestRecordsInner {
  ...
  public UpsertrecordsRequestRecordsInner() {
  }

  public UpsertrecordsRequestRecordsInner attributes(@jakarta.annotation.Nullable Object attributes) {
  ...
  public UpsertrecordsRequestRecordsInner identifiers(@jakarta.annotation.Nullable UpsertrecordsRequestRecordsInnerOneOf1Identifiers identifiers) {
  ...
  public UpsertrecordsRequestRecordsInner associations(@jakarta.annotation.Nullable List<UpsertrecordsRequestRecordsInnerOneOf1AssociationsInner> associations) {
    
    this.associations = associations;
    return this;
  }

  public UpsertrecordsRequestRecordsInner addAssociationsItem(UpsertrecordsRequestRecordsInnerOneOf1AssociationsInner associationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpsertrecordsRequestRecordsInner upsertrecordsRequestRecordsInner = (UpsertrecordsRequestRecordsInner) o;
    return Objects.equals(this.attributes, upsertrecordsRequestRecordsInner.attributes) &&
        Objects.equals(this.identifiers, upsertrecordsRequestRecordsInner.identifiers) &&
        Objects.equals(this.associations, upsertrecordsRequestRecordsInner.associations);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpsertrecordsRequestRecordsInner {\n");

 ...
 */
@JsonPropertyOrder({
  CrmTasksIdPatchRequest.JSON_PROPERTY_NAME,
  CrmTasksIdPatchRequest.JSON_PROPERTY_DURATION,
  CrmTasksIdPatchRequest.JSON_PROPERTY_TASK_TYPE_ID,
  CrmTasksIdPatchRequest.JSON_PROPERTY_DATE,
  CrmTasksIdPatchRequest.JSON_PROPERTY_NOTES,
  CrmTasksIdPatchRequest.JSON_PROPERTY_DONE,
  CrmTasksIdPatchRequest.JSON_PROPERTY_ASSIGN_TO_ID,
  CrmTasksIdPatchRequest.JSON_PROPERTY_CONTACTS_IDS,
  CrmTasksIdPatchRequest.JSON_PROPERTY_DEALS_IDS,
  CrmTasksIdPatchRequest.JSON_PROPERTY_COMPANIES_IDS,
  CrmTasksIdPatchRequest.JSON_PROPERTY_REMINDER
})
@JsonTypeName("_crm_tasks__id__patch_request")
public class CrmTasksIdPatchRequest {
  ...
  public CrmTasksIdPatchRequest name(@jakarta.annotation.Nullable String name) {
  ...
  public CrmTasksIdPatchRequest duration(@jakarta.annotation.Nullable Long duration) {
  ...
  public CrmTasksIdPatchRequest taskTypeId(@jakarta.annotation.Nullable String taskTypeId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TASK_TYPE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_TASK_TYPE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTaskTypeId(@jakarta.annotation.Nullable String taskTypeId) {
    this.taskTypeId = taskTypeId;
  }

  public CrmTasksIdPatchRequest date(@jakarta.annotation.Nullable OffsetDateTime date) {
  ...
  public CrmTasksIdPatchRequest notes(@jakarta.annotation.Nullable String notes) {
  ...
  public CrmTasksIdPatchRequest done(@jakarta.annotation.Nullable Boolean done) {
  ...
  public CrmTasksIdPatchRequest assignToId(@jakarta.annotation.Nullable String assignToId) {
  ...
  public CrmTasksIdPatchRequest contactsIds(@jakarta.annotation.Nullable List<Integer> contactsIds) {
    
    this.contactsIds = contactsIds;
    return this;
  }

  public CrmTasksIdPatchRequest addContactsIdsItem(Integer contactsIdsItem) {
  ...
  public CrmTasksIdPatchRequest dealsIds(@jakarta.annotation.Nullable List<String> dealsIds) {
    
    this.dealsIds = dealsIds;
    return this;
  }

  public CrmTasksIdPatchRequest addDealsIdsItem(String dealsIdsItem) {
  ...
  public CrmTasksIdPatchRequest companiesIds(@jakarta.annotation.Nullable List<String> companiesIds) {
    
    this.companiesIds = companiesIds;
    return this;
  }

  public CrmTasksIdPatchRequest addCompaniesIdsItem(String companiesIdsItem) {
  ...
  public CrmTasksIdPatchRequest reminder(@jakarta.annotation.Nullable TaskReminder reminder) {
  ...
  public boolean equals(Object o) {
    ...
    CrmTasksIdPatchRequest crmTasksIdPatchRequest = (CrmTasksIdPatchRequest) o;
    return Objects.equals(this.name, crmTasksIdPatchRequest.name) &&
        Objects.equals(this.duration, crmTasksIdPatchRequest.duration) &&
        Objects.equals(this.taskTypeId, crmTasksIdPatchRequest.taskTypeId) &&
        Objects.equals(this.date, crmTasksIdPatchRequest.date) &&
        Objects.equals(this.notes, crmTasksIdPatchRequest.notes) &&
        Objects.equals(this.done, crmTasksIdPatchRequest.done) &&
        Objects.equals(this.assignToId, crmTasksIdPatchRequest.assignToId) &&
        Objects.equals(this.contactsIds, crmTasksIdPatchRequest.contactsIds) &&
        Objects.equals(this.dealsIds, crmTasksIdPatchRequest.dealsIds) &&
        Objects.equals(this.companiesIds, crmTasksIdPatchRequest.companiesIds) &&
        Objects.equals(this.reminder, crmTasksIdPatchRequest.reminder);
  }
  ...
  public String toString() {
    ...
    sb.append("class CrmTasksIdPatchRequest {\n");

...
public class GetSharedTemplateUrl {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_SHARED_URL, required = true)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSharedUrl() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%ssharedUrl%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSharedUrl()), "UTF-8").replaceAll("\\+", "%20")));

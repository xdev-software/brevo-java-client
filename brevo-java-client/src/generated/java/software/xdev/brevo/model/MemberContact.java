...
public class MemberContact {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MEMBER_CONTACT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMemberContactId() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%smemberContactId%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMemberContactId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
